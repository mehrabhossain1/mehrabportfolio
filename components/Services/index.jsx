...
const Services = () => {
  return (
    <div className="max-w-screen-xl mx-auto py-20 px-12 md:px-24 flex flex-col space-y-24 items-center justify-center">
            ...
            .map((_, i) => (
              ...
              >
                <CardHeader className="text-2xl md:text-xl text-end p-0 text-green-100 basis-2/3 md:basis-9/12 space-y-3">
                  ...
                  <CardDescription className="text-slate-200 text-end">
                    I build responsive and pixel-perfect ui.
                  </CardDescription>
                </CardHeader>
