...
const Footer = () => {
  return (
    <div className="max-w-screen-xl mx-auto px-10 flex flex-col gap-10 md:px-24 pt-20">
      ...
      <div className="flex flex-col gap-10 md:flex-row md:justify-between items-stretch">
        <div className="flex flex-col gap-6 basis-1/2">
          <div>
            <p className="text-justify text-zinc-800/90 dark:text-zinc-100/90 text-[15px]">
      ...
      <div className="text-center font-mono border-t border-zinc-600 py-12 space-y-2">
        <h1 className="text-base font-semibold text-zinc-400">
          Designed & Developed by Mehrab Hossain
        </h1>
